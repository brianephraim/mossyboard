...
> = Readonly<{
  ...
  defaultBorderColor?: ComponentProps<typeof TextArea>["borderColor"];
  defaultValue?: FieldPathValue<TFieldValues, TName>;
  description?: string;
  fieldProps?: FormFieldFrameProps["fieldProps"];
  inputId?: string;
  invalidBorderColor?: ComponentProps<typeof TextArea>["borderColor"];
  label: string;
...
>({
  ...
  const resolvedBorderColor = fieldState.invalid
    ? invalidBorderColor
    : (defaultBorderColor ?? textAreaProps.borderColor);
